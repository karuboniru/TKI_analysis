...
int main(int argc, char *argv[]) {
  ...
  auto action = df_pi0.Snapshot("tree", "outputpi0.root",
                                {"TKIVars", "weight", "neutrino_p", "muon_p",
                                 "full_hadron", "realpn", "realpL"},
                                opts);
  auto action1 = df_0pi.Snapshot("tree", "output0pi.root",
                                 {"TKIVars", "weight", "neutrino_p", "muon_p",
                                  "full_hadron", "realpn", "realpL"},
                                 opts);
